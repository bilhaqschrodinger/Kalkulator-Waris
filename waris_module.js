...
function findWasmBinary() {
  return locateFile('waris_module.wasm');
}
...
var _hitungWarisWasm = Module['_hitungWarisWasm'] = makeInvalidEarlyAccess('_hitungWarisWasm');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['hitungWarisWasm'] != 'undefined', 'missing Wasm export: hitungWarisWasm');
  ...
  _hitungWarisWasm = Module['_hitungWarisWasm'] = createExportWrapper('hitungWarisWasm', wasmExports['hitungWarisWasm'], 9);
